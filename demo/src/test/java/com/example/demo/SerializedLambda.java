...
public class SerializedLambda implements Serializable {
     ...
     */
    public static SerializedLambda resolve(LambdaFunction lambda) {
        if (!lambda.getClass().isSynthetic()) {
            throw new UnsupportedOperationException("该方法仅能传入 lambda 表达式产生的合成类");
        }
        try (ObjectInputStream objIn = new ObjectInputStream(new ByteArrayInputStream(SerializationUtils.serialize(lambda))) {
            ...
            throw new UnsupportedOperationException("This is impossible to happen", e);
        }
    }
