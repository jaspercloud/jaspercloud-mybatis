...
import com.jaspercloud.plus.resolver.TemplateMethod;
import com.jaspercloud.plus.resolver.TemplateMethodResolver;
...
public class JasperMybatisMapperRegistry extends MapperRegistry {
    ...
    public JasperMybatisMapperRegistry(Configuration config) {
        super(config);
        if (!(config instanceof JasperMybatisConfiguration)) {
            throw new IllegalArgumentException(JasperMybatisConfiguration.class.getName());
        }
        this.config = (JasperMybatisConfiguration) config;
    }
